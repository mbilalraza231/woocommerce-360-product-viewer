...
## ✨ Key Features
- **🚀 High Performance**: Zero dependencies, lightweight vanilla JavaScript.
...
- **🎮 Navigation Controls**: Clean, modern glassmorphism UI for Zoom, Prev, and Next actions.
...
- **📍 Hotspot Support**: Built-in layer for future interactive marker support.
...
3. Visit **'360 Viewer'** in your sidebar to configure your settings.

---

## 📖 Usage

Display the viewer anywhere using a simple shortcode:
...
- Ensure all images have the same dimensions and are centered.
...
## 📄 License
Licensed under the MIT License. Feel free to use and customize for your own projects!
